...
# Episode parameters
MAX_EPISODES = 850 #500 #650
MAX_STEPS_PER_EPISODE = 1500 #1200
MIN_TIME_BETWEEN_ACTIONS = 0.0 #0.0
...
# Log file directory
LOG_FILE_DIR = DATA_PATH + '/Epsilon_reconstruct_action_state_space_850eps_1500steps_90d'
